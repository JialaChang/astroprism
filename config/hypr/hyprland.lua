...
-- Per-machine values
-- deploy.sh copies the right config/hosts/<profile>/hypr-host.lua here
local ok, host = pcall(dofile, os.getenv("HOME") .. "/.config/hypr/host.lua")
if not ok or type(host) ~= "table" then
	host = { gaps_out = 20, autostart = {} }
end
